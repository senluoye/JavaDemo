package com.qks.aop.annotation.interceptor;
...
public class TransferLogAdvice {
     ...
     * 定义切点的目的是为了更好地服用切入点
     */
    @Pointcut("execution(* com.qks.aop.annotation.service.Impl.BankServiceImpl.*(..))")
    public void pointcut1() {
    }

    @Pointcut("execution(* com.qks.aop.annotation.service.Impl.*ServiceImpl.*(..))")
